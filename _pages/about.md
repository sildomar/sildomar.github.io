...
Dr. Sildomar Monteiro is a senior research scientist and program manager with [Aurora Flight Sciences](http://www.aurora.aero/){:target="_blank"}. He is a principal investigator on multiple projects fully funded by the DARPA and AFRL in collaboration with MIT. His expertise is in AI, machine learning, computer vision, and robotics, areas he has been researching since 2001. He was a senior AI/ML researcher at [Boeing Research & Technology](https://www.boeing.com/innovation/){:target="_blank"}. 

Prior to joining Boeing in 2018, he was an assistant professor of robotics at the [Rochester Institute of Technology](https://www.rit.edu/kgcoe/electrical/){:target="_blank"}, where he directed the Intelligent Sensing and Robotics Lab. Prior to RIT, he was a research scientist in the [Australian Centre for Field Robotics](https://sydney.edu.au/engineering/our-research/robotics-and-intelligent-systems/australian-centre-for-field-robotics.html){:target="_blank"} at the University of Sydney.
